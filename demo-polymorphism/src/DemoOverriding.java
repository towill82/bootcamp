public class DemoOverriding { // dynamic polymorphism (run-time)
  ...
  public static void main(String[] args) {
    ...
    // During runtime, the new cat object is created in heap memory, 
    // then the object ref "animal" will point to animal object and execute walk method.
    // That is Animal.walk()

    // Example 3
    animal = new Dog();
    // animal.sleep(); // error, because the object reference type determined the scope of the object.
