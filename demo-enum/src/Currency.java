public enum Currency {
  ...
  // 2 -> USD, 3 -> JPY
    ...
    //     return "It is Hong Kong Dollars.";
  ...
  public static void main(String[] args) {
    ...
    System.out.println(currency); // "Currency(descripton=Hong Kong Dollar.DBValue=1)"

    // ENUM already override Object.toString() -> HKD
    System.out.println(currency.toString()); // "Currency(descripton=Hong Kong Dollar.DBValue=1)"
    ...
    System.out.println(Currency.HKD.hashCode()); // 1704856573
    System.out.println(Currency.USD.hashCode()); // 705927765

    System.out.println(Currency.JPY.equals(currency)); //false
    System.out.println(Currency.HKD.equals(currency)); //true

    System.out.println(currency.equals(currency));
    System.out.println(currency != null && currency.equals(Currency.HKD));

    String x = "abc";

    // NOT OK. If String x = null;
